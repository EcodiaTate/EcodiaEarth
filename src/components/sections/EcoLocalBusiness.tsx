...
function IntegrationPillar({
  ...
  return (
    <div className="group p-12 transition-all duration-700 hover:bg-[#2D2B28] hover:text-[#F9F8F5]">
      ...
      <h3 className="mb-6 text-[11px] font-black uppercase tracking-[0.4em]">
        {title}
      </h3>
      <p className="text-sm leading-relaxed opacity-60 group-hover:opacity-100">
        {desc}
      </p>
    </div>
  );
