...
const PRINCIPLES = [
  {
    id: "01",
    title: "Shared Upside",
    text: "Action returns to where it happens. Value circulates locally before it travels outward.",
    trace: "#7FD069",
  },
  {
    id: "02",
    title: "Design Over Discipline",
    text: "Structure shapes behaviour. What repeats is what the world makes possible.",
    trace: "#396041",
  },
  {
    id: "03",
    title: "Doing Counts",
    text: "Progress exists only in movement. What is done carries forward.",
    trace: "#F4D35E",
  },
  {
    id: "04",
    title: "Scale Emerges",
    text: "Continuity comes from return. Accumulation outpaces force.",
    trace: "#7FD069",
  },
  {
    id: "05",
    title: "Mutual Benefit",
    text: "Personal gain and shared gain move together. Separation weakens both.",
    trace: "#396041",
  },
  {
    id: "06",
    title: "Local First",
    text: "Change resolves closest to where life is lived. Place is the unit of progress.",
    trace: "#F4D35E",
  },
  {
    id: "07",
    title: "Play Sustains",
    text: "Curiosity keeps systems alive. Rhythm sustains return.",
    trace: "#7FD069",
  },
];
      ...
      <div className="relative z-10 pl-[8%] pr-[15%] py-32">
        ...
        <header className="mb-64 space-y-16 border-b-8 border-[#2D2B28] pb-24">
          ...
          <p className="max-w-3xl text-3xl font-medium leading-tight tracking-tighter opacity-80 border-l border-[#2D2B28] pl-12">
            Patterns that hold across time.
          </p>
        </header>
        ...
        <footer className="mt-96 flex flex-col items-end gap-12 border-t-8 border-[#2D2B28] pt-16 opacity-30">
          <div className="text-right space-y-4">
            <div className="text-[11px] font-black uppercase tracking-[0.5em] leading-relaxed">
              Written while running. <br /> Adjusted in motion.
            </div>
