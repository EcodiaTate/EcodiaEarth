...
const LEGAL_CLAUSES: Clause[] = [
  {
    ...
    desc: "We collect what we need to run Ecodia. Identifiers stay tied to the account. Retention follows function.",
    trace: "#7FD069",
  ...
  },
  {
    ...
    desc: "Ecodia is shared space. Misuse is handled with consistent removal to protect the whole.",
    trace: "#396041",
  ...
  },
  {
    ...
    desc: "Patterns, code, and logic are published to extend. You may learn from, fork, amend, and maintain them.",
    trace: "#F4D35E",
      ...
      <div className="relative z-10 pl-[8%] pr-[15%] py-32">
        ...
        <header className="mb-64 space-y-16 border-b-8 border-[#2D2B28] pb-24">
          ...
          <p className="max-w-3xl text-3xl font-medium leading-tight tracking-tighter opacity-80 border-l border-[#2D2B28] pl-12">
            Privacy, terms, and open publication. Written for reading.
          </p>
        </header>
          ...
          <div className="lg:col-span-8 space-y-64">
            {LEGAL_CLAUSES.map((c) => (
              ...
              >
                ...
                <div
                  className="h-2 w-16 transition-all duration-700 group-hover:w-48"
          ...
          <aside className="lg:col-span-4 lg:pl-24">
            <div className="sticky top-48 space-y-24 border-l border-[#2D2B28]/10 pl-16">
              <div className="space-y-10">
                <h3 className="text-[11px] font-black uppercase tracking-[0.6em] opacity-30 italic">
                  Registry_Summary
                </h3>
                <ul className="space-y-6 text-xs font-black uppercase tracking-[0.4em] opacity-60">
                  <li className="flex items-center gap-4 group hover:text-[#7FD069] transition-colors">
                    <div className="h-2 w-2 bg-[#7FD069]" /> Privacy: Minimal.
                  </li>
              ...
              <div className="space-y-8 pt-12">
                <h3 className="text-[11px] font-black uppercase tracking-[0.6em] opacity-30">
                  Direct_Signal
                </h3>
                <a
                  href="mailto:legal@ecodia.au"
        ...
        <footer className="mt-96 flex flex-col md:flex-row items-end justify-between border-t border-[#2D2B28]/10 pt-16 opacity-30">
          <div className="text-[9px] uppercase tracking-[0.8em] font-black italic">
            Public_Registry_Record_v1.0
          </div>
