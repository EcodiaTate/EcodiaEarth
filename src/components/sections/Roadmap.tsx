 ...
 * Strategy: Timeline. Delivery. Drift.
...
const phases = [
  {
    ...
    id: "01",
    title: "FIRST RUNS",
    desc: "Sidequests drafted and tested in public. The rules get tightened under use.",
    stat: "FIELD_RUNS",
    trace: "#396041",
  },
  {
    ...
    id: "02",
    title: "RECORD",
    desc: "A shared log for work in place. Submissions, review, and a running archive.",
    stat: "LOG_ON",
    trace: "#7FD069",
  },
  {
    ...
    id: "03",
    title: "CIRCULATION",
    desc: "ECO links work to local return. Rewards move through participating places.",
    stat: "ECO_FLOW",
    trace: "#F4D35E",
  },
  {
    ...
    id: "04",
    title: "DISTRICTS",
    desc: "Local ops kits. Partner places host runs. Crews keep cadence and keep it clean.",
    stat: "DISTRICTS",
    trace: "#396041",
  },
];
    ...
    >
      ...
      >
        {[...Array(40)].map((_, i) => (
          <div
            key={i}
            className="absolute left-0 w-8 h-[2px] bg-[#2D2B28] opacity-20"
            style={{ top: `${i * 120}px` }}
          >
            <span className="absolute left-12 -top-3 text-[9px] font-black opacity-30 tracking-widest">
              {i * 10}mm
            </span>
          </div>
        ))}
      ...
      <div className="relative z-10 pl-[8%] pr-[15%] py-32">
        ...
        <header className="mb-96 space-y-16">
          ...
          <p className="max-w-3xl text-3xl font-medium leading-tight tracking-tighter opacity-80 border-l border-[#2D2B28] pl-12">
            A timeline of the work. What shipped. What starts next.
          </p>
        </header>
        ...
        <div className="relative space-y-96 pb-96">
          {phases.map((phase, i) => (
            <BlueprintRow key={phase.id} data={phase} index={i} />
          ))}
        ...
        <footer className="mt-64 border-t-8 border-[#2D2B28] pt-16 opacity-30 flex flex-col md:flex-row justify-between items-end gap-12">
          ...
          <div className="text-[10px] uppercase tracking-[0.8em] font-black">
            26.6500° S // Drift_Stable // 2025
          </div>
        </footer>
      </div>
    </main>
      ...
      <div className={`md:col-span-5 ${isEven ? "md:col-start-1" : "md:col-start-8"}`}>
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            ...
            <p className="text-2xl font-medium leading-tight opacity-70">{data.desc}</p>
          </div>
