  ...
  return (
    <div className="relative min-h-screen w-full select-none overflow-hidden bg-[#F9F8F5] font-mono text-[#2D2B28]">
      ...
      <div className="absolute right-[8%] top-12 z-50">
        <img src="/icons/leaf-black.svg" alt="Leaf" className="w-10 h-10 opacity-60" />
      </div>
      ...
      <main className="relative z-10 pl-[8%] pr-[15%] py-32">
        ...
        <section className="mb-48">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <span className="text-[10px] tracking-[0.6em] uppercase opacity-40">Local registry</span>
            </div>
            ...
            <div className="grid grid-cols-1 gap-24 border-l border-[#2D2B28] pl-16 lg:grid-cols-2 lg:items-end">
              <p className="text-3xl font-medium leading-tight tracking-tighter opacity-80 max-w-xl">
                Show up in real places. Leave a mark. The value stays close.
              </p>
              ...
              <div className="pb-4">
                ...
                >
                  <span className="text-xs font-black uppercase tracking-[0.5em]">Open map</span>
        ...
        <section className="mt-64 grid grid-cols-1 md:grid-cols-3 border-y border-[#2D2B28]">
          <DocumentationCard step="01" title="Spot" body="Find places built to last. Start there." />
          <DocumentationCard step="02" title="Mark" body="Do something small. Leave the leaf." />
          <DocumentationCard step="03" title="Share" body="Your ECO grows. Others can join in." />
        </section>
        ...
        <section className="mt-64 grid grid-cols-1 lg:grid-cols-12 gap-px bg-[#2D2B28]/10 border-x border-[#2D2B28]/10">
          <div className="lg:col-span-7 bg-[#F9F8F5] p-16 lg:p-24 border-b lg:border-b-0 lg:border-r border-[#2D2B28]/10">
            <div className="mb-16 flex items-center gap-3 opacity-30">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.5em]">People</span>
            </div>
            ...
            <p className="mb-16 max-w-md text-xl opacity-70 leading-tight">
              Keep going back to the places that hold up. Collect marks from the ones that fit.
            </p>
          ...
          <div className="lg:col-span-5 bg-[#F9F8F5] p-16 lg:p-24 flex flex-col justify-between">
            <div>
              <div className="mb-16 flex items-center gap-3 opacity-30">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.5em]">Places</span>
              </div>
              <h2 className="mb-12 text-5xl font-black tracking-tighter uppercase leading-none">JOIN THE GRID.</h2>
              <p className="mb-16 text-lg opacity-70 leading-snug">
                Come in as a verified place. Built for shops, studios, and hubs that last.
              </p>
            </div>
            <SmoothLink
              href="/business"
        ...
        <footer className="mt-64 flex flex-col items-end justify-between border-t border-[#2D2B28]/10 pt-16 md:flex-row opacity-30">
          <div className="text-[10px] uppercase tracking-[0.8em]">26.6500° S // 153.0667° E</div>
...
function DocumentationCard({ step, title, body }: { step: string; title: string; body: string }) {
  return (
    <div className="group relative bg-[#F9F8F5] p-16 transition-all duration-700 hover:bg-[#2D2B28] hover:text-[#F9F8F5]">
      <div className="mb-24 text-[10px] font-black opacity-20 group-hover:opacity-100 uppercase tracking-[0.5em]">{step}</div>
      <h3 className="mb-8 text-5xl font-black tracking-tighter uppercase leading-none">{title}</h3>
      <p className="text-xl leading-tight opacity-70 group-hover:opacity-100">{body}</p>
      {/* State glyph */}
