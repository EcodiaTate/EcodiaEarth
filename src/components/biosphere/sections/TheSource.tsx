        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 space-y-12">
            <header>
              ...
              {/* REPLACED "The Source" WORDMARK WITH LOGO */}
              <div className="space-y-6">
                <div className="relative w-[260px] md:w-[340px] h-[72px]">
                  <Image
              ...
              {techSpecs.map((spec, i) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    <span className="source-code text-[10px] opacity-40 group-hover:text-[var(--accent-color)]">
                      {spec.log}
                    </span>
            ...
            <p className="max-w-xl text-lg opacity-60 font-serif leading-relaxed">
              This is the photosynthesis of our technology. We use a peer-to-peer mesh that mirrors the mycorrhizal
              networks of a forest. Transparent, immutable, and powered by the sun.
            </p>
          </div>
